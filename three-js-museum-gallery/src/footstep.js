...
module.exports = () => {
    ...
    return {
        ...
        step: (pos, run) => {
            ...
            osc.frequency.setValueAtTime(0, t + p.touch + p.hold + p.release);
            gain.gain.cancelScheduledValues(t);
            gain.gain.setValueAtTime(0, t);
            gain.gain.linearRampToValueAtTime(vol, t + p.touch);
            gain.gain.setValueAtTime(vol, t + p.touch + p.hold);
            gain.gain.linearRampToValueAtTime(0, t + p.touch + p.hold + p.release);
        }
    };
};